...
describe("PermissionPrompt", () => {
  ...
  it("shows the origin and a human-readable permission label on request", () => {
    ...
    expect(
      screen.getByRole("dialog", { name: "Permission request" }),
    ).toBeTruthy();
