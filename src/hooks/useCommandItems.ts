 ...
 */
export function useCommandItems(query: string, close: () => void): CommandItem[] {
...
type OverlayKey = Parameters<ReturnType<typeof useBrowserStore.getState>['toggleOverlay']>[0];
