...
export const BookmarksPanel: React.FC = () => {
  ...
  const close = useCallback(() => toggleOverlay('showBookmarks'), [toggleOverlay]);
          ...
          {bookmarks.map((b) => (
            <li key={b.id} className="group">
              ...
              >
                ...
                >
                  <div className="text-sm truncate" style={{ color: 'var(--chrome-fg)' }}>
                    {b.title || b.url}
                  </div>
                  <div className="text-xs truncate" style={{ color: 'var(--chrome-fg-muted)' }}>
                    {b.url}
                  </div>
                </button>
                <button
                  ...
                  style={{ color: 'var(--chrome-fg-muted)', transition: 'opacity var(--transition-fast)' }}
                >
                  Remove
                </button>
              </div>
