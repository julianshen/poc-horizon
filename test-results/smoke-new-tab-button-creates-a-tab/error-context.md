...
- Name: smoke.spec.ts >> new-tab button creates a tab
- Location: tests/e2e/smoke.spec.ts:31:5
...
Locator: getByText('New Tab').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('New Tab').first()
