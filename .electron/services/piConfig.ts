...
export function buildPiSettings(
  ...
  if (cfg.activeProvider) out.defaultProvider = cfg.activeProvider;
  const activeModel = cfg.models[cfg.activeProvider];
  if (activeModel) out.defaultModel = activeModel;
