...
export default function (pi: ExtensionAPI): void {
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("navigate", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("click", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    label: "Type text",
    description:
      "Type text into the currently focused input. Click a field first to focus it.",
    parameters: Type.Object({
      text: Type.String(),
      delayMs: Type.Optional(Type.Number()),
    }),
    execute: async (_id, params) =>
      bridge("type", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    label: "Scroll page",
    description:
      "Scroll the active page by a delta. deltaY positive = scroll down.",
    parameters: Type.Object({
    ...
    execute: async (_id, params) =>
      bridge("scroll", params as Record<string, unknown>),
  });
      ...
      try {
        ...
        return {
          content: [
            {
              type: "text" as const,
              text: `Screenshot failed: ${(err as Error).message}`,
            },
          ],
          details: { error: (err as Error).message },
        };
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({
      order: Type.Optional(
        Type.Union([Type.Literal("reading"), Type.Literal("dom")]),
      ),
      format: Type.Optional(
        Type.Union([Type.Literal("png"), Type.Literal("jpeg")]),
      ),
      ...
      try {
        ...
        return {
          content: [
            {
              type: "text" as const,
              text: `Marked screenshot failed: ${(err as Error).message}`,
            },
          ],
          details: { error: (err as Error).message },
        };
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("evaluate", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    label: "Get DOM",
    description:
      "Get a depth-limited DOM tree of the current page. Cheaper than screenshot for structural queries.",
    parameters: Type.Object({ depth: Type.Optional(Type.Number()) }),
    execute: async (_id, params) =>
      bridge("getDom", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("waitFor", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("describeAt", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("saveHelper", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("callHelper", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    description:
      "List the saved JS helpers — names + descriptions. Check this first before deriving a snippet you may already have.",
    parameters: Type.Object({}),
  ...
  pi.registerTool({
    ...
    description:
      "Delete a saved JS helper by name. Use when a helper no longer applies (site redesigned, wrong implementation, etc).",
    parameters: Type.Object({ name: Type.String() }),
    execute: async (_id, params) =>
      bridge("removeHelper", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("cdpSubscribe", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("cdpCollect", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    description:
      "Stop receiving a specific event method, or all methods if no arg.",
    parameters: Type.Object({ method: Type.Optional(Type.String()) }),
    execute: async (_id, params) =>
      bridge("cdpUnsubscribe", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("cdp", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("compact", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("workflowRecordStart", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("workflowRun", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    description:
      "List saved workflows by name (no step bodies). Check first before recording — you may already have one.",
    parameters: Type.Object({}),
  ...
  pi.registerTool({
    ...
    description:
      "Delete a saved workflow by name. Returns {removed: true|false}.",
    parameters: Type.Object({ name: Type.String() }),
    execute: async (_id, params) =>
      bridge("workflowDelete", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("tabOpen", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("tabSwitch", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({ id: Type.String() }),
    execute: async (_id, params) =>
      bridge("tabClose", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({ name: Type.String() }),
    execute: async (_id, params) =>
      bridge("skillReadInteraction", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("domainSkillList", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("domainSkillRead", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("domainSkillSave", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    execute: async (_id, params) =>
      bridge("domainSkillSearch", params as Record<string, unknown>),
  });
  ...
  pi.registerTool({
    ...
    parameters: Type.Object({ host: Type.String(), name: Type.String() }),
    execute: async (_id, params) =>
      bridge("domainSkillRemove", params as Record<string, unknown>),
  });
